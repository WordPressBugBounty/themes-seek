...
// Top Header Advertise Section.
$wp_customize->add_section( 'top_header_add_section_settings',
	array(
		'title'      => __( 'Top Header Advertise Section', 'seek' ),
		'priority'   => 90,
...
$wp_customize->add_setting( 'sort_trending_post_by',
	array(
		...
		'capability'        => 'edit_theme_options',
		'sanitize_callback' => 'seek_sanitize_select',
	)
);
$wp_customize->add_control( 'sort_trending_post_by',
	array(
		'label'    => esc_html__( 'Short Trending Post By', 'seek' ),
		'section'  => 'main_header_section_settings',
		'choices'  => array(
                'date' => __( 'Latest Post', 'seek' ),
                'rand' => __( 'Random Post', 'seek' ),
                'comment_count' => __( 'Most Commented', 'seek' ),
		    ),
		'type'     => 'select',
		'priority' => 150,
	)
...
$wp_customize->add_control( 'enable_header_fix_nav',
	array(
		'label'    => __( 'Enable Fix Navigation', 'seek' ),
		'section'  => 'main_header_section_settings',
		'type'     => 'checkbox',
		'priority' => 150,
	)
