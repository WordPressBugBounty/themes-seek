 ...
 * @since 1.0.0
 */
class Seek_Widget_Base extends WP_Widget {
		...
		switch ( $field_type ) {
			...
			case 'image':
				...
				<div>
					...
					<!-- <br /> -->
					<input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'seek' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'seek' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'seek' ); ?>" />
					<?php
					$image_status = false;
					if ( ! empty( $value ) ) {
						$image_status = true;
					...
					?>
					<input type="button" value="<?php echo esc_attr_x( 'X', 'Remove', 'seek' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
