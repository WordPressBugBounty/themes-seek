                        ...
                        ?>
                            <li class="twp-list-post twp-d-flex">
                                <div class="twp-image-section twp-image-hover">
                                    ...
                                    <a  href="<?php the_permalink(); ?>" class="data-bg" data-background="<?php echo esc_url($featured_image); ?>">
                        ...
                        <div class="twp-row">
                            ...
                            <?php setup_postdata($post); ?>
                                    ...
                                    <div class="twp-col-4">
                                        <div class="twp-feature-post twp-box-shadow-sm">
                                            <div class="twp-image-section twp-image-lg twp-image-hover">
                                                ...
                                                $featured_image = isset($featured_image[0]) ? $featured_image[0] : '';
                                                ?>
                                                <a class="data-bg d-block twp-overlay-image-hover" href="<?php the_permalink(); ?>" data-background="<?php echo esc_url($featured_image); ?>">
                                                </a>
                                                <span class="twp-post-format-absolute">
                                                    <?php echo esc_attr(seek_post_format(get_the_ID())); ?>
                                                </span>
                                ...
                                <?php if (($count > 1 && $count <= 3 )) { ?>
                                    ...
                                    $featured_image = isset($featured_image[0]) ? $featured_image[0] : '';
                                    ?>
                                    <div class="twp-full-post twp-full-post-md data-bg twp-overlay-image-hover" data-background="<?php echo esc_url( $featured_image); ?>">
                        ...
                        <?php foreach ($all_posts as $key => $post) : ?>
                            ...
                            <div class="twp-feature-post">
                                <div class="twp-image-section twp-image-sm twp-image-hover">
                                    ...
                                    <a class="data-bg twp-overlay-image-hover" href="<?php the_permalink(); ?>" data-background="<?php echo esc_url($featured_image); ?>">
                                    </a>
