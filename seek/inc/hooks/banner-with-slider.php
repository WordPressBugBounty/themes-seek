                                ...
                                <div class="twp-col-half">
                                    <div class="twp-full-post-list">
                                        ...
                                        while ($seek_main_banner_banner_post_query_args_2->have_posts()) : $seek_main_banner_banner_post_query_args_2->the_post();
                                            ...
                                            $featured_image = isset($featured_image[0]) ? $featured_image[0] : '';
                                            ?>
                                        <div class="twp-full-post twp-full-post-sm data-bg twp-overlay-image-hover" data-background="<?php echo esc_url($featured_image); ?>">
                            ...
                            <div class="twp-banner-slider"  data-slick='{"rtl": <?php echo($rtl_class_c); ?>}'>
                                ...
                                while ($seek_main_banner_banner_post_query->have_posts()) : $seek_main_banner_banner_post_query->the_post();
                                    ...
                                    <div class="twp-banner-slider-wrapper">
                                        <div class="twp-full-post twp-full-post-lg data-bg twp-overlay-image-hover" data-background="<?php echo esc_url($featured_image); ?>">
                                            <a class="img-link" href="<?php the_permalink(); ?>" aria-label="<?php the_title_attribute(); ?>" tabindex="0"></a>
                                            <div class="twp-wrapper twp-overlay twp-w-100">
                                                <div class="twp-categories-with-bg twp-categories-with-bg-primary">
                                                    <?php seek_post_categories(); ?>
                                                </div>
                                                <h3 class="twp-post-title twp-post-title-md"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
                                                <div class="twp-social-share-section">
                                                    <div class="twp-author-meta m-0">
