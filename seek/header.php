	...
	<header id="masthead" class="site-header">
		<?php if (seek_get_option('show_addvertisement_section') == 1) { ?>
			<div class="twp-ad-section">
				<div class="container">
					<div class="twp-ad">
						<a href="<?php echo esc_url(seek_get_option('top_section_advertisement_url')); ?>" target="_blank">
							<img src="<?php echo esc_url(seek_get_option('top_section_advertisement')); ?>" alt="">
						</a>
					</div><!--/twp-ad-->
				</div>		
			</div>	
		...
		<div class="twp-site-branding data-bg clearfix <?php echo esc_attr($image_header_class); ?>" data-background="<?php echo esc_url(get_header_image()); ?>">
			<div class="container">
				...
				<div class="twp-article-list" id="nav-latest-news-field">
					<div class="container">
						<?php
        					...
        					$seek_trending_sort = esc_attr(seek_get_option('sort_trending_post_by'));
							
							$args = array(
								'post_type' => 'post',
								'posts_per_page' =>  12,
								'ignore_sticky_posts' => 1,
								'orderby' => esc_attr($seek_trending_sort),
								'order' => 'DESC',
